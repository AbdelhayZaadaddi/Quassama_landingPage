...
export default function SavingGoalsSection() {
    ...
    const highlights = [
      {
        ...
        title: t('savingGoals.highlights.item1.title'),
        description: t('savingGoals.highlights.item1.description'),
      },
      {
        icon: (
          <svg
        ...
        title: t('savingGoals.highlights.item2.title'),
        description: t('savingGoals.highlights.item2.description'),
      },
      {
        icon: (
          <svg
        ...
        title: t('savingGoals.highlights.item3.title'),
        description: t('savingGoals.highlights.item3.description'),
      },
    ];
  ...
  return (
    <section id="savings" className="bg-[#f8faf9] py-20 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-col justify-evenly items-center h-full px-3"
          >
            <div className="relative max-w-2xl w-full">
              ...
              <div className="relative rounded-4xl border border-[#d9e7e4] bg-white p-4 shadow-sm">
                <div className="rounded-2xl bg-[#2f6f68] p-4 text-white">
                  <p className="text-sm font-medium text-white/80">
                    {t('savingGoals.mockup.sectionLabel')}
                  </p>
                  <p className="mt-1 text-3xl font-bold leading-none">
                    2,632 DH
                  </p>
                  <p className="mt-1 text-xs text-white/75">
                    {t('savingGoals.mockup.totalSavings')}
                  </p>
                </div>
                ...
                <div className="mt-4 space-y-3">
                  <div className="rounded-xl border border-gray-200 bg-[#fcfdfd] p-3">
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <span className="rounded-full bg-[#e8f1f0] px-2 py-0.5 text-xs font-semibold text-[#3A7068]">
                        {t('savingGoals.mockup.statusCompleted')}
                      </span>
                    </div>
                  ...
                  <div className="rounded-xl border border-gray-200 bg-[#fcfdfd] p-3">
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <span className="rounded-full bg-[#e8f1f0] px-2 py-0.5 text-xs font-semibold text-[#3A7068]">
                        {t('savingGoals.mockup.statusActive')}
                      </span>
                    </div>
                    <div className="h-2 rounded-full bg-gray-200">
              ...
              >
                <p className="text-xs text-gray-500 font-medium">
                  {t('savingGoals.mockup.totalSaved')}
                </p>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-white text-sm font-semibold">
                    {t('savingGoals.mockup.goalCompleted')}
                  </p>
                </div>
                <p className="text-white/70 text-xs mt-0.5">
                  {t('savingGoals.mockup.goalCompletedSub')}
                </p>
              </motion.div>
            </div>

            {/* Progress bar illustration */}
            <div className="mt-10 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm max-w-2xl w-full">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700">
                  {t('savingGoals.mockup.challengeLabel')}
                </span>
                <span className="text-sm font-bold text-[#3A7068]">
                  {t('savingGoals.mockup.challengePercent')}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between mt-2">
                <span className="text-xs text-gray-400">
                   {t('savingGoals.mockup.challengeProgress')}
                </span>
          ...
          <motion.div variants={textVariants} className="flex flex-col">
            ...
            <h2 className="text-[#3A7068] text-3xl md:text-5xl font-bold mb-4 leading-tight">
              {t('savingGoals.title.line1')} <br />
              <span className="text-gray-900">{t('savingGoals.title.line2')}</span>
            </h2>

            {/* Subtext */}
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed mb-10">
              {t('savingGoals.description')}
            </p>
