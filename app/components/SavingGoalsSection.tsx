...
import SavingGoalsImage from '../../assets/SavingGoals.png';

const highlights = [
  {
    icon: (
      <svg className="w-6 h-6 text-[#3A7068]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
      </svg>
    ),
    title: "Set a Target & Timeline",
    description: "Define how much you want to save and in how many days. Quassama builds your daily saving plan automatically.",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-[#3A7068]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Get a personalized daily saving target so you never fall behind your goal — small steps, big results.",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-[#3A7068]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Run several saving challenges at once — for a trip, a gadget, or an emergency fund — all in one place.",
  },
];
        ...
        >
          ...
          >
            <div className="relative">
              ...
              <Image
                src={SavingGoalsImage}
                alt="Quassama Saving Goals Feature"
                className="relative w-full max-w-xs sm:max-w-sm lg:max-w-md h-auto object-contain drop-shadow-2xl"
                priority
                quality={100}
              />
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-white text-sm font-semibold">Goal Completed!</p>
                </div>
                <p className="text-white/70 text-xs mt-0.5">1,000 DH in 30 days 🎉</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div variants={textVariants} className="flex flex-col">
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed mb-10">
              Saving money has never felt this structured. Set a target, choose your timeline, and Quassama breaks it down into achievable daily goals — so you stay on track without the stress.
            </p>
            ...
            <div className="mt-10 bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700">30 Days Challenge</span>
                <span className="text-sm font-bold text-[#3A7068]">100% Saved</span>
              </div>
