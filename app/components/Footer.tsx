      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
          ...
          <div className="flex items-center gap-4">
            {/* TikTok */}
            <a href="https://www.tiktok.com/@quassama.app?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener noreferrer" className="bg-[#3A7068] p-2 rounded-md hover:opacity-90 transition-opacity">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/quassama.app?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="bg-[#3A7068] p-2 rounded-md hover:opacity-90 transition-opacity">
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
