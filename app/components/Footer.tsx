      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
          ...
          <div className="flex items-center gap-2">
             {/* Using the same logo, usually you might want a dark version for white backgrounds */}
             <div className="relative h-8 w-8 md:h-10 md:w-10">
                {/* Placeholder for the logo which seems to be teal in the footer */}
                <Image
                  src="/logo1.png"
                  alt="Quassama Logo"
                  width={40}
                  height={40}
                  className="object-contain" // You might need a dark version of the logo here
                 />
             </div>
          ...
          <div className="flex items-center gap-4">
            {/* TikTok */}
            <a href="#" className="bg-[#3A7068] p-2 rounded-md hover:opacity-90 transition-opacity">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/quassama.app/" className="bg-[#3A7068] p-2 rounded-md hover:opacity-90 transition-opacity">
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
