...
export default function Hero() {
  return (
    <section className="bg-[#3A7068] w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20 md:pt-16 md:pb-28">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 space-y-8 text-center md:text-left z-10 w-full">
            ...
            <p className="text-gray-200 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto md:mx-0">
              ...
              No more confusion, no awkward reminders, and no messy calculations. Just clear expenses 
              and balanced groups.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 pt-4">
              {/* Google Play Placeholder */}
              <button className="flex items-center gap-3 bg-white text-black px-4 py-2 rounded-lg hover:bg-gray-100 transition-colors border border-gray-300 w-48 justify-center sm:justify-start">
               {/* Typical Google Play Icon SVG Shape */}
            ...
            <p className="text-sm text-gray-300">
               {/* Optional small text referencing availability */}
            </p>
          </div>

          {/* Right Column: Image Placeholder */}
          <div className="flex-1 w-full flex justify-center md:justify-end relative">
             <div className="w-full max-w-sm md:max-w-md aspect-[9/16] bg-white/5 rounded-3xl border-2 border-dashed border-white/20 flex flex-col items-center justify-center text-white/40 p-6 text-center">
                <svg className="w-16 h-16 mb-4 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <p className="font-semibold text-lg">Your Image Here</p>
                <p className="text-sm mt-2">Place your "Hand holding phone" image here.</p>
                <p className="text-xs mt-2 text-white/30">Recommended size: ~500x800px transparent PNG</p>
             </div>
          </div>
