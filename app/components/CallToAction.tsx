    ...
    <section className="bg-[#1A1A1A] text-white pt-20 pb-0 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          {/* Left Content */}
          <motion.div 
            className="w-full md:w-1/2 mb-12 md:mb-20 z-10 text-center md:text-left"
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <motion.div 
              ...
              variants={itemVariants}
            >
              {/* Google Play Button - Changed w-48 to w-full sm:w-48 */}
              <a 
              ...
              {/* App Store Button - Changed w-48 to w-full sm:w-48 */}
              <a 
